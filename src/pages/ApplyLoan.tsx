    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
            ...
            <ol className="space-y-3">
              {[
                ...
                <li key={i} className="flex items-start gap-3 text-sm">
                  <span className="flex-shrink-0 w-5 h-5 rounded-full bg-gradient-to-r from-[#F2A9DD] via-[#C8B2F5] to-[#F7FAE4] flex items-center justify-center text-xs font-medium text-gray-800">
                    {i + 1}
                  </span>
          ...
          {/* Security */}
          <div className="bg-gradient-to-r from-[#F2A9DD]/10 via-[#C8B2F5]/10 to-[#F7FAE4]/10 rounded-xl p-6">
            <div className="flex items-start gap-3">
              <Shield className="w-5 h-5 text-[#C8B2F5] flex-shrink-0 mt-0.5" />
              <div>
