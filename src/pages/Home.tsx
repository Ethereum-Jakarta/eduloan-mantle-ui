  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-[#F2A9DD]/10 via-[#C8B2F5]/10 to-[#F7FAE4]/10" />
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-full shadow-sm border border-gray-100 mb-6">
              <div className="w-6 h-6 rounded-full bg-gradient-to-r from-[#F2A9DD] via-[#C8B2F5] to-[#F7FAE4] flex items-center justify-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
              Decentralized
              <span className="block bg-gradient-to-r from-[#F2A9DD] via-[#C8B2F5] to-[#F7FAE4] bg-clip-text text-transparent">
                Student Loans
              </span>
            </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {[
            ...
            <div key={item.step} className="text-center">
              <div className="w-12 h-12 mx-auto mb-4 rounded-full bg-gradient-to-r from-[#F2A9DD] via-[#C8B2F5] to-[#F7FAE4] flex items-center justify-center">
      ...
      {/* CTA Section */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-gradient-to-r from-[#F2A9DD]/20 via-[#C8B2F5]/20 to-[#F7FAE4]/20 rounded-2xl p-8 md:p-12 text-center">
